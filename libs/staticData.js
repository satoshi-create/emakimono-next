const ja = {
  ...
  variation: {
    title: "さまざまな絵巻",
    titleen: "variation",
    desc: "絵巻の全盛期は平安時代末期から室町時代です。冊子形式の読書が普及するにつれ、絵巻は徐々に廃れていきました。しかし、江戸時代に入ってもなお、絵巻は描かれていましたし、明治には日本画家が絵巻を描いています。時を越えて描かれてきた絵巻には、多様な表情があり、絵巻のなかに日本の歴史の息遣いを感じることができるのです。",
    name: "variation",
    columns: "four",
  },
  history: {
