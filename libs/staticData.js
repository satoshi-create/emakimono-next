const ja = {
  ...
  bandainagon: {
    ...
    desc: "「伴大納言絵詞」の上巻・中巻・下巻を、縦書きや横スクロールでお楽しみいただけます。この絵巻は、平安時代末期、絵巻愛好家として知られる後白河法皇のプロデュースにより、謎の天才絵師・常盤光長の手によって制作された、連続式絵巻の最高峰です。応天門の炎上シーンを圧倒的な迫力で描いた上巻から、悲嘆に暮れる伴家の女房たちの生々しい描写まで、喜怒哀楽が織りなす見どころ満載の絵巻です。",
    name: "bandainagon",
    columns: "three",
  },
  shigisan: {
  ...
  genji: {
    ...
    desc: "「源氏物語」の54帖は、「源氏絵」としても知られ、絵巻や屏風をはじめとする多様な「ワイド美術」として描かれ、長きにわたって鑑賞の対象となってきました。徳川美術館に秘蔵される源氏物語絵巻は、現存する中で最も古いものであり、絵巻の起源を探るうえで欠かせない重要な巻物です。絵巻から屏風に至るまで、描かれた「源氏物語」の世界を存分にお楽しみください。",
    name: "genji",
    columns: "three",
  },
  favorite: {
  ...
  variation: {
    title: "さまざまな絵巻",
    titleen: "various emakis",
    desc: "絵巻の全盛期は平安時代末期から室町時代です。冊子形式の読書が普及するにつれ、絵巻は徐々に廃れていきました。しかし、江戸時代に入ってもなお、絵巻は描かれていましたし、明治には日本画家が絵巻を描いています。貴族の世、武士の世、仏教の浸透、中国との交流、南蛮文化の影響、変遷していく時代を見つめてきた絵巻には、さまざまな表情があります。",
    name: "variation",
    columns: "four",
  },
  flow: {
    title: "流れる巻物!!",
    titleen: "flowing scroll!!",
    desc: "",
    name: "flow",
    columns: "four",
  },
  ...
  famousscene: {
    title: "絵巻名場面集！！",
    titleen: "great scenes from the emakis!",
    desc: "",
    name: "famousscene",
    columns: "",
  },
  alpha: {
    title: "横スクロールで楽しむワイド美術",
    titleen: "Side-scrolling art for your enjoyment",
    desc: "横スクロールで再発見できる美術は、絵巻だけに限りません。例えば、屏風や襖絵をはじめ、日本の美術品の多くは、広がりのある「ワイド美術」として創作されています。西洋にも「バイユーのタピストリー」やフレスコ画といった、絵解きの要素を持つ美術が数多く存在します。また、近代に入ると、ジャポニズムの影響を受けたモネが、連作「睡蓮」でまるで襖絵のように部屋を囲むような作品を制作しました。",
    name: "alpha",
    columns: "four",
  },
  about: {
    ...
    title: "絵巻物の原風景を求めて",
    text1: `絵巻物を左へ左へと少しづつ繰り展げ、スクリーン上に次々と現れては消えていく絵を追いながら、物語の世界に没入することこそが、本来の絵巻物の見方であり、絵巻物の魅力です。それは「絵を鑑賞する」というよりは「アニメーションを味わう」感じに近いです。絵巻物について書かれた書籍は数あれど、残念ながら繰り展げつつ見ることはできません。また、実際の絵巻物を手に取る機会も早々多くはありません。
          <br />
          <br />
    ...
    text2: `  絵巻物を味わうには、最初はちょっと根気がいるかもしれません。この世界にはすでに、マンガやアニメ、映画など、リッチなコンテンツが溢れていますし、読み方や見方など特に気にすることなく楽しむことができるからです。でも、ぼくは、絵巻物が描かれた時代に生きていた人たちも、現在の自分たちがマンガやアニメを楽しむのと同じような感覚で、絵巻物に接していたと思います。実際、絵巻物には流線表現や画中詞（セリフ）、異時同図（コマワリ）など、マンガやアニメを彷彿とさせる技法が多くあります。なによりも、読者が、次々に現れる絵を通して物語を追いかけるという見方は、マンガやアニメとまったく同じです。
          <br />
          <br />
...
const en = {
  ...
  history: {
    title: "Emakis in Historical Perspective",
    titleen: "時代から見る絵巻",
    desc: "",
    name: "history",
    columns: "two",
  ...
  about: {
    sectiontitle: "about",
    sectiontitleen: "ご挨拶",
    title: "In Search of the Original Landscape of the Picture Scroll",
