const data = [
  ...
  },
  {
    ...
    metadesc:
      "九相図巻の全シーンを、横スクロールで楽しむことができます。美しい女の人が、死後朽ち果てるまでの変容を９つの相に分け、肉体の美醜が生々しく描かれています。煩悩を退けるための仏教の修行に使われたと言われています。",
  ...
  },
  {
    ...
    metadesc:
      "九相図の全シーンを、横スクロールで楽しむことができます。明治時代の浮世絵師、小林永濯の作品です。多くの九相図は小野小町や檀林皇后がモデルとなっていますが、こちらは近世～近代の作品らしく、娼婦がモデルになっています。",
  ...
  },
  {
    ...
    metadesc:
      "九相詩絵巻の全シーンを、縦書き、横スクロールで楽しむことができます。九相図巻から時代が下った作品で、詞書や画中詞（和歌）、風景が添えられており、自然のうつろい、はかなさが重ねられています。",
